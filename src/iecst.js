    ...
    return {
        ...
        keywords: {
            tag:
                ...
                "end_step initial_step namespace end_namespace channel end_channel library end_library folder end_folder resource end_resource method end_method property end_property interface end_interface",
            keyword: "if then end_if elsif else case of end_case to do by " +
            "while repeat end_while end_repeat for end_for from public " +
            "private protected constant return exit at retain non_retain " +
            "persistent task with until using extend INTERVAL",
            title:
        ...
        contains: [
            ...
            {
                className: "operator",
                begin: "\\b(NOT|AND|OR|XOR|AND_THEN|OR_THEN|MOD|LE|GE|EQ|NE|LT|GT)\\b",
            },
            {
                className: "property",
                begin: "(?<=\\b[a-zA-Z0-9_]+\\.)[a-zA-Z]+[a-zA-Z0-9_]*\\b",
            },
            {
            ...
            },
            {
                // GX Works2 Symbolic Addresses
                className: "literal",
                begin: "\\b(X|Y|TC|TS|TN|CC|CS|CN)[0-9]{1,3}",
            },
            {
                className: "symbol",
